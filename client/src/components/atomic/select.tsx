      ...
      {options.map(({ value: optionValue, label, description, icon: Icon }) => {
        ...
        return (
          <button
            ...
            className={cn(
              'relative flex flex-col items-start gap-2 rounded-xl p-4 text-left transition-all duration-150',
              'border focus:outline-none focus-visible:ring-2 focus-visible:ring-[#bf0000]/30',
              selected
                ? 'border-[#bf0000] bg-[#bf0000]/[0.04] dark:bg-[#bf0000]/10'
                : 'border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/[0.02] hover:border-gray-300 dark:hover:border-white/20 hover:bg-white dark:hover:bg-white/[0.04]'
            )}
          >
            {/* Selected indicator dot */}
            {selected && (
              <span className="absolute top-3 right-3 w-2 h-2 rounded-full bg-[#bf0000]" />
            )}
              ...
              <span
                className={cn(
                  ...
                  selected
                    ...
                    : 'bg-white dark:bg-white/10 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-white/10'
                )}
              >
                <Icon size={15} />
              </span>

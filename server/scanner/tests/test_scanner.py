...
class ScanFolderTests(SimpleTestCase):
    ...
    def test_runs_lsast_and_marks_scan_completed(self, mock_ast, mock_update, mock_lsast):
    ...
    def test_records_error_and_returns_empty_on_ast_failure(self, mock_ast, mock_update, mock_lsast):
        result = scanner_module.scan_folder("/x", "s1", "user-1", "Scan #1")
